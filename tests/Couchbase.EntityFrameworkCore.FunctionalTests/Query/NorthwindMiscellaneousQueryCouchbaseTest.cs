...
using Couchbase.EntityFrameworkCore.FunctionalTests.Query;
    ...
    public override async Task Select_expression_datetime_add_month(bool async)
    {
        await AssertQuery(
            ...
            elementAsserter: (e, a) =>
            {
                ...
                {
                    // difference between how Couchbase and everyone else add months
                    // e.g. when adding 1 month to Jan 31st, we get March 2/3 on Couchbase and Feb 28th/29ths for everyone else
...
""");
    ...
    {
        // modifying the original scenario - Couchbase gives inaccurate results for values of granularity less than 1 second
        await AssertQuery(
            async,
    ...
    public override async Task Client_code_unknown_method(bool async)
        => await AssertTranslationFailedWithDetails(
            ...
            CoreStrings.QueryUnableToTranslateMethod(
                "Microsoft.EntityFrameworkCore.Query.NorthwindMiscellaneousQueryTestBase<Microsoft.EntityFrameworkCore.Query.NorthwindQueryCouchbaseFixture<Microsoft.EntityFrameworkCore.TestUtilities.NoopModelCustomizer>>",
