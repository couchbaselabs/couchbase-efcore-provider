...
public class NorthwindDbFunctionsQueryCouchbaseTest : NorthwindDbFunctionsQueryRelationalTestBase<NorthwindQueryCouchbaseFixture<NoopModelCustomizer>>
{
    public NorthwindDbFunctionsQueryCouchbaseTest(
