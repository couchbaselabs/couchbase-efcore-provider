...
public class NorthwindSplitIncludeQueryCouchbaseTest : NorthwindSplitIncludeQueryTestBase<NorthwindQueryCouchbaseFixture<NoopModelCustomizer>>
{
    public NorthwindSplitIncludeQueryCouchbaseTest(
