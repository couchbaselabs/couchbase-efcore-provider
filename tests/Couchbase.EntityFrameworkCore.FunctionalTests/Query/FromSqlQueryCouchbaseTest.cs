...
public class FromSqlQueryCouchbaseTest : FromSqlQueryTestBase<NorthwindQueryCouchbaseFixture<NoopModelCustomizer>>
{
    public FromSqlQueryCouchbaseTest(NorthwindQueryCouchbaseFixture<NoopModelCustomizer> fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
