...
using Infrastructure = Microsoft.EntityFrameworkCore.Infrastructure;
...
#pragma warning restore EF1001 // Internal EF Core API usage.
        ...
        protected override Expression VisitMethodCall(MethodCallExpression methodCallExpression)
        {
            if (methodCallExpression.Method.IsGenericMethod
                ...
                == Microsoft.EntityFrameworkCore.Infrastructure.ExpressionExtensions.ValueBufferTryReadValueMethod)
            {
        ...
        private sealed class QueryableJsonEntityMaterializerRewriter : ExpressionVisitor
        {
            ...
            protected override Expression VisitBinary(BinaryExpression binaryExpression)
            {
                ...
                if (binaryExpression is
                    ...
                    && method.GetGenericMethodDefinition() == Microsoft.EntityFrameworkCore.Infrastructure.ExpressionExtensions.ValueBufferTryReadValueMethod)
                {
