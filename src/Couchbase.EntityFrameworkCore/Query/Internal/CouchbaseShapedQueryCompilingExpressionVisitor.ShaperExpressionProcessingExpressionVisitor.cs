...
public partial class CouchbaseShapedQueryCompilingExpressionVisitor
{
    private sealed class ShaperExpressionProcessingExpressionVisitor : ExpressionVisitor
    {
        ...
        private readonly CouchbaseShapedQueryCompilingExpressionVisitor _couchbaseShapedQueryCompilingExpressionVisitor;
        ...
        public ShaperExpressionProcessingExpressionVisitor(
            CouchbaseShapedQueryCompilingExpressionVisitor inMemoryShapedQueryCompilingExpressionVisitor,
            InMemoryQueryExpression inMemoryQueryExpression,
            bool tracking)
        {
            _couchbaseShapedQueryCompilingExpressionVisitor = inMemoryShapedQueryCompilingExpressionVisitor;
            ...
            switch (extensionExpression)
            {
                case StructuralTypeShaperExpression shaper:
                {
                    ...
                    if (!_mapping.TryGetValue(key, out var variable))
                    {
                        ...
                        var innerShaper =
                            _couchbaseShapedQueryCompilingExpressionVisitor.InjectStructuralTypeMaterializers(shaper);
                ...
                case IncludeExpression includeExpression:
                {
                    ...
                    if (includeExpression.Navigation.IsCollection)
                    {
                        ...
                        var shaperLambda = new ShaperExpressionProcessingExpressionVisitor(
                                _couchbaseShapedQueryCompilingExpressionVisitor, _tracking)
